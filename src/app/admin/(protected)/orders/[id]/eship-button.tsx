      ...
      <div className="p-5 rounded-xl bg-white border border-[#E2E8F0] space-y-3" style={{ boxShadow: "0 2px 8px rgba(15,23,42,0.04)" }}>
        ...
        <div className="flex gap-2">
          <button
            ...
            disabled={loading}
            className="flex items-center gap-2 px-3 py-2 rounded-full bg-white border border-[#E2E8F0] text-[#334155] text-xs font-medium hover:bg-[#F6FAFF] transition-colors disabled:opacity-50"
          >
