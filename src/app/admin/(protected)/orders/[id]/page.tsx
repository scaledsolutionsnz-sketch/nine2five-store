...
export default async function OrderDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const STATUS_COLORS: Record<string, string> = {
    ...
    delivered:  "bg-[#CDEEDC] text-[#166B3B]",
      ...
      <div className="grid lg:grid-cols-[1fr_300px] gap-6">
        <div className="space-y-6">
          ...
          <div className="p-6 rounded-xl bg-white border border-[#E2E7EF]" style={{ boxShadow: "0 2px 8px rgba(15,23,42,0.04)" }}>
            ...
            <div className="mt-4 pt-4 border-t border-[#E2E7EF] space-y-2 text-sm">
              ...
              <div className="flex justify-between font-bold text-base text-[#1F2937] pt-1 border-t border-[#E2E7EF]">
        ...
        <div className="space-y-4">
          <div className="p-5 rounded-xl bg-white border border-[#E2E7EF]" style={{ boxShadow: "0 2px 8px rgba(15,23,42,0.04)" }}>
