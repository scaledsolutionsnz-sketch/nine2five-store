...
export default function OrderConfirmedPage() {
  return (
    <div className="bg-[#112016] min-h-screen flex flex-col items-center justify-center px-8 text-center">
      ...
      <CheckCircle className="h-16 w-16 text-[#3a7722] mb-6" />
      ...
      <Link
        href="/account/orders"
        className="bg-[#3a7722] text-white font-bold text-sm uppercase tracking-widest px-8 py-4 rounded-full hover:bg-[#4d9e2e] transition-all duration-300 mb-4"
      >
        View My Orders
      </Link>
      <Link
