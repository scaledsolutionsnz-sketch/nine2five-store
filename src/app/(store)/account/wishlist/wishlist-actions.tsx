...
export function WishlistActions({ productId }: { productId: string }) {
  ...
  return (
    <button
      onClick={remove}
      className="absolute top-2 right-2 p-1.5 rounded-lg bg-[#112016]/60 text-[#737373] hover:text-red-400 hover:bg-[#112016]/80 transition-colors opacity-0 group-hover:opacity-100"
    >
