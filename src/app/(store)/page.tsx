    ...
    <div>
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 max-w-3xl mx-auto">
          <p className="text-xs font-semibold uppercase tracking-[0.3em] text-[#16a34a] mb-4">
            Māori Grip Socks
          </p>
          <h1 className="font-display font-black text-5xl md:text-7xl leading-none tracking-tight text-white mb-6">
            BUILT FOR<br />THE TURF
          </h1>
          <p className="text-[#a3a3a3] text-lg mb-10 max-w-lg mx-auto leading-relaxed">
            Premium grip socks designed for rugby, sport, and training. Māori inspired. New Zealand made.
          </p>
      ...
      <section className="py-24 px-6 md:px-10 max-w-6xl mx-auto">
        <div className="flex items-end justify-between mb-12">
          <div>
            ...
            <h2 className="font-display font-bold text-3xl md:text-4xl">Featured Designs</h2>
          </div>
      ...
      <section className="py-16 px-6 md:px-10 max-w-6xl mx-auto">
        <div className="flex flex-wrap gap-3 justify-center">
          {["Rugby", "Touch Rugby", "Gym", "Reformer Pilates", "Training", "Schools", "Clubs", "Māori Sport"].map((tag) => (
            <span
              key={tag}
              className="px-4 py-2 rounded-full border border-[#262626] text-sm text-[#737373] font-medium"
            >
              {tag}
            </span>
          ))}
      ...
      <section id="about" className="py-24 px-6 md:px-10 max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-1 md:order-2">
            ...
            <p className="text-[#737373] leading-relaxed mb-8">
              Every design is inspired by Māori patterns, whakapapa, and the culture that drives our community. Worn by rugby players, gym athletes, and young people who carry their identity with them everywhere.
            </p>
            <p className="font-display font-bold text-sm text-white">
              — Wiremu Bartlett, Founder
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-6">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-[#737373] mb-8">Limited drops. Pre-orders live now.</p>
